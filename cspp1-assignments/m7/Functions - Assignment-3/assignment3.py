...
payment had to be a multiple of $10. Why did we make it that way? You can try running
# your code locally so that the payment can be
any dollar and cent amount (in other words, the monthly payment is a multiple of $0.01).
# Does your code still work? It should, but you
may notice that your code runs more slowly, especially in cases with very large balances
# and interest rates. (Note: when your code is running on our
servers, there are limits on the amount of computing time each submission
...
payment than we did in Problem 2 without running into the problem of slow
# code?
...
info check out the Wikipedia page on bisection search) to find
...
your solution to Problem 2 to compare!). Produce the same return
